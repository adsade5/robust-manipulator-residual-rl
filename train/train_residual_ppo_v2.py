...
def main() -> None:
    ...
    probe_env = ResidualTrackingEnv(randomize_scale=True, nominal_sample_probability=NOMINAL_EPISODE_PROBABILITY, seed=SEED)
    ...
    model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=callback, tb_log_name="ppo_residual_v2")
